...
##Silent Features: 
	...
	2.Each character has different colour, font size, orientation and position 
	3.Final captcha has many lines with different orientation, size, position and colour.
**********************************************#END#**************************************
